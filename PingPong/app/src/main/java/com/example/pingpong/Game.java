...
public class Game extends Activity implements SurfaceHolder.Callback {
    ...
    private void draw() {
        ...
        if (canvas != null) {
            ...
            Paint paintEnemyText = new Paint();
            paintEnemyText.setTextSize(50);
            paintEnemyText.setColor(Color.WHITE);
            canvas.drawText("Inimigo: " + enemyScore,20,70, paintEnemyText);

            Paint paintPlayerText = new Paint();
            paintPlayerText.setTextSize(50);
            paintPlayerText.setColor(Color.WHITE);
            canvas.drawText("Você: " + playerScore, 20,2170, paintPlayerText);
